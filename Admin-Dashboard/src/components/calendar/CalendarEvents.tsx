...
const CalendarEvents = () => {
  ...
  const fetchEvents = async () => {
    try {
      const response = await axios.get("https://thegrandtravelsbackend.vercel.app/api/events");
  ...
  const handleAddEvent = async (title: string) => {
    ...
    if (title && selectedDate) {
      try {
        const response = await axios.post("https://thegrandtravelsbackend.vercel.app/api/events", {
          title,
  ...
  const handleConfirmDelete = async () => {
    if (selectedEvent) {
      try {
        await axios.delete(`https://thegrandtravelsbackend.vercel.app/api/events/${selectedEvent.event.id}`);
