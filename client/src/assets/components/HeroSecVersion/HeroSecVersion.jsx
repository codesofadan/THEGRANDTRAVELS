...
import "./HeroSecVersion.css";
import SearchBar from "../SearchBar/SearchBar";
// import { fetchPopupImage } from "../../services/api"; // Commented out the API import

const HeroSecVersion = () => {
  const [isModalOpen, setIsModalOpen] = useState(true);
  // const [popupImage, setPopupImage] = useState(""); // Commented out the state for API image
  ...
  //   };
  //   getImage();
  // }, []); // Commented out the useEffect for fetching the image

  // Use a static image URL instead
  const popupImage = "modaloffer.jpeg";
